...
A interação dos tratamentos é significativa, num nível de 1% de significância, portanto não é possível analisar os efeitos principais separadamente, é necessária analisar a interação dos mesmos. Para isso primeiro se analisa a interação da  profundidade de corte dentro de cada taxa de avanço e depois se analisa a taxa de avanço dentro de cada profundidade de corte.

```{r}
summary(anova2)
```

Ao analisar o efeito das taxas de avanço, com todas as profundidades de corte juntas, temos que a taxa de 0.3 in/min é a única não significativa à um nível de significância de 1%.
...
# profundidades de corte dentro da taxa de avanço de 0.25 in/min
HSD.test(y = metal$acabam[metal$taxa == "0.25"], 
         trt = metal$corte[metal$taxa == "0.25"],
...
Analisando o resultado das taxas de avanço dentro da profundidade de corte, temos que somente a profundidade de corte de 0.25 in não é significativa para o acamento da superfície do metal.
